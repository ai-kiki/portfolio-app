        ...
        <div class="io-case">
          ...
          <main class="io-wrap">
            ...
            <section class="io-reflection">
              ...
              <article><span>What I would revisit</span><h3>Redesign the system, not only the workflow</h3><p>Given the opportunity, I would evaluate replacing the legacy insertion-order experience instead of building automation around it, while retaining the validation logic that made the new process useful. I would also build error tracking into the workflow; direct visibility into error-rate trends after handoff would provide clearer quantitative evidence of long-term ROI.</p></article>
            </section>
          </main>
